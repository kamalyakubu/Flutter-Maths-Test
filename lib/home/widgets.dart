  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: SizedBox(
        ...
        // IconButton(
        //   onPressed: onPressed,
        //   icon: Lottie.asset('assets/play.json')
        //   // Icon(
      ...
      child: DefaultTextStyle.merge(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(value,
                style: mainData
                    ? theme.homePageMainStatText
                    : theme.homePageStatText),
          ],
        ),
      ),
    );
...
class ReflectionShape extends ContinuousRectangleBorder {
  ...
  Path getOuterPath(Rect rect, {TextDirection? textDirection}) {
    ...
    double radius =
        Offset(rect.width, rightPadding - leftPadding).distance * this.radius;
